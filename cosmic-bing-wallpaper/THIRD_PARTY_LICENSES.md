# Third-Party Licenses for cosmic-bing-wallpaper

This document lists all third-party dependencies used by cosmic-bing-wallpaper and their licenses.

**cosmic-bing-wallpaper** itself is licensed under **MPL-2.0**.

## License Summary

| License | Count |
|---------|-------|
| Apache-2.0 OR MIT | 391 |
| MIT | 190 |
| Apache-2.0 | 18 |
| Unicode-3.0 | 18 |
...
| Apache-2.0 OR CC0-1.0 OR MIT | 1 |
| Unlicense | 1 |
...
- **bit_field** v0.10.3
  ...
  - Simple bit field trait providing get_bit, get_bits, set_bit, and set_bits methods for Rust's inte...
...
- **cc** v1.2.52
  ...
  - A build-time dependency for Cargo build scripts to assist in invoking the native C compiler to co...
...
- **ctor-lite** v0.1.0
  - Repository: https://codeberg.org/notgull/ctor-lite
...
- **fluent** v0.17.0
  ...
  - An umbrella crate exposing the combined features of fluent-rs crates with additional convenience ...

- **fluent-bundle** v0.16.0
  - Repository: https://github.com/projectfluent/fluent-rs
  - A low-level implementation of a collection of localization messages for a single locale for Proje...
...
- **fluent-syntax** v0.12.0
  - Repository: https://github.com/projectfluent/fluent-rs
  - A low-level parser, AST, and serializer API for the syntax used by Project Fluent, a localization...
...
- **ipnet** v2.11.0
  ...
  - Provides types and useful methods for working with IPv4 and IPv6 network addresses, commonly call...
...
- **pkg-config** v0.3.32
  ...
  - A library to run the pkg-config system tool at build time in order to be used in Cargo build scri...
...
- **rangemap** v1.7.1
  ...
  - Map and set data structures whose keys are stored as ranges.  Contiguous and overlapping ranges t...
...
- **scoped-tls** v1.0.1
  ...
  - Library implementation of the standard library's old `scoped_thread_local!` macro for providing s...
...
- **sha2** v0.10.9
  - Repository: https://github.com/RustCrypto/hashes
  - Pure Rust implementation of the SHA-2 hash function family including SHA-224, SHA-256, SHA-384, a...
...
- **stable_deref_trait** v1.2.1
  ...
  - An unsafe marker trait for types like Box and Rc that dereference to a stable address even when m...
...
- **typenum** v1.19.0
  ...
  - Typenum is a Rust library for type-level numbers evaluated at     compile time. It currently supp...
...
- **unicode-script** v0.5.8
  ...
  - This crate exposes the Unicode `Script` and `Script_Extension` properties from [UAX #24](http://w...
...
- **unicode-xid** v0.2.6
  ...
  - Determine whether characters have the XID_Start or XID_Continue properties according to Unicode S...
...
- **winapi-i686-pc-windows-gnu** v0.4.0
  - Repository: https://github.com/retep998/winapi-rs
  - Import libraries for the i686-pc-windows-gnu target. Please don't use this crate directly, depend...

- **winapi-x86_64-pc-windows-gnu** v0.4.0
  - Repository: https://github.com/retep998/winapi-rs
  - Import libraries for the x86_64-pc-windows-gnu target. Please don't use this crate directly, depe...
...
- **cosmic-freedesktop-icons** v0.4.0
...
- **i18n-config** v0.4.8
  ...
  - This library contains the configuration stucts (along with their parsing functions) for the cargo...

- **i18n-embed** v0.16.0
  - Repository: https://github.com/kellpossible/cargo-i18n/tree/master/i18n-embed
  - Traits and macros to conveniently embed localization assets into your application binary or libra...

- **i18n-embed-fl** v0.10.0
  - Repository: https://github.com/kellpossible/cargo-i18n/tree/master/i18n-embed-fl
  - Macro to perform compile time checks when using the i18n-embed crate and the fluent localization ...

- **i18n-embed-impl** v0.8.4
  - Repository: https://github.com/kellpossible/cargo-i18n/tree/master/i18n-embed
...
- **iced_runtime** v0.14.0-dev
  - Repository: https://github.com/iced-rs/iced
  - A renderer-agnostic runtime for iced

- **iced_tiny_skia** v0.14.0-dev
  - Repository: https://github.com/iced-rs/iced
...
- **objc2-link-presentation** v0.2.2
  - Repository: https://github.com/madsmtm/objc2
...
- **objc2-uniform-type-identifiers** v0.2.2
  - Repository: https://github.com/madsmtm/objc2
  - Bindings to the UniformTypeIdentifiers framework

- **objc2-user-notifications** v0.2.2
  - Repository: https://github.com/madsmtm/objc2
...
- **rgb** v0.8.52
  ...
  - `struct RGB/RGBA/etc.` for sharing pixels between crates + convenience methods for color manipula...

- **rust-embed** v8.11.0
  - Repository: https://pyrossh.dev/repos/rust-embed
  - Rust Custom Derive Macro which loads files into the rust binary at compile time during release an...

- **rust-embed-impl** v8.11.0
  - Repository: https://pyrossh.dev/repos/rust-embed
  - Rust Custom Derive Macro which loads files into the rust binary at compile time during release an...
...
- **tokio-native-tls** v0.3.1
  ...
  - An implementation of TLS/SSL streams for Tokio using native-tls giving an implementation of TLS f...
...
- **wayland-protocols-misc** v0.3.10
  - Repository: https://github.com/smithay/wayland-rs
...
- **wayland-protocols-wlr** v0.3.10
  - Repository: https://github.com/smithay/wayland-rs
  - Generated API for the WLR wayland protocol extensions

- **wayland-scanner** v0.31.8
  - Repository: https://github.com/smithay/wayland-rs
  - Wayland Scanner for generating rust APIs from XML wayland protocol files.

- **wayland-server** v0.31.11
  - Repository: https://github.com/smithay/wayland-rs
...
- **zvariant_derive** v3.15.2
  - Repository: https://github.com/dbus2/zbus/
  - D-Bus & GVariant encoding & decoding

- **zvariant_derive** v4.2.0
  - Repository: https://github.com/dbus2/zbus/
  - D-Bus & GVariant encoding & decoding

- **zvariant_derive** v5.9.1
  - Repository: https://github.com/z-galaxy/zbus/
  - D-Bus & GVariant encoding & decoding
...
- **apply** v0.3.0
  - Repository: https://github.com/burtonageo/apply
  - A tiny library for chaining free functions into method call chains.

- **cosmic-client-toolkit** v0.1.0

- **cosmic-config** v0.1.0

- **cosmic-config-derive** v0.1.0

- **cosmic-settings-daemon** v0.1.0

- **cosmic-theme** v0.1.0

- **dnd** v0.1.0

- **iced_accessibility** v0.1.0
...
- **libloading** v0.8.9
  ...
  - Bindings around the platform's dynamic library loading primitives with greatly improved memory sa...
...
- **cosmic-bing-wallpaper** v0.2.4
  - Bing Daily Wallpaper manager for COSMIC desktop
...
- **num_enum_derive** v0.7.5
  - Repository: https://github.com/illicitonion/num_enum
  - Internal implementation details for ::num_enum (Procedural macros to make inter-operation between...
...
The full text of commonly used licenses can be found at:
...
*This file was auto-generated using `cargo license`.*